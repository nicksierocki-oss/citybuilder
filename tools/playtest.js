...
// Balance guard (CI fails on these): see "Checks before pushing" in CLAUDE.md. Only on the
// default plains maps, which the targets are tuned for.
if (!process.env.LAND || process.env.LAND === 'plains') {
  const problems = [];
